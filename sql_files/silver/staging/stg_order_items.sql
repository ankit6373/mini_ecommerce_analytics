...
ALTER TABLE ORDER_ITEMS SET COMMENT = 'This table stores information about the orders including their status, delivery date, shipping date and sales price. This table stores the full details of the orders with their sales price. We will mostly be using this table for further analysis related to orders';
